...
//#define VECT_TAB_SRAM
#if defined(VECT_TAB_SRAM)
#define VECT_TAB_BASE_ADDRESS   D1_DTCMRAM_BASE   /*!< Vector Table base address field.
                                                       This value must be a multiple of 0x400. */
#define VECT_TAB_OFFSET         0x00000000U       /*!< Vector Table base offset field.
                                                       This value must be a multiple of 0x400. */
#else
...
#endif /* USER_VECT_TAB_ADDRESS */
//    memcpy((void *) VECT_TAB_BASE_ADDRESS, (void *) 0x08000000, 0x400); /* Copy the vector table from the Flash (mapped at the base of the application
